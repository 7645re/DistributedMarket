...
public class CartsByProductRepository : BaseRedisRepository<CartsByProductIdEntity>, ICartsByProductRepository
{
    ...
    public CartsByProductRepository(
        IDistributedCache cache,
        IOptions<RedisOptions> redisOptions) : base(cache)
    {
    ...
    {
        return base.CreateAsync(key, entity, TimeSpan.FromMinutes(_redisOptions.CartsByProductExpiryInMinutes),
            cancellationToken);
    }
}