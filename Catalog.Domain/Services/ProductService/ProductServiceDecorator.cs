...
public class ProductServiceDecorator : IProductService
{
    ...
    {
        using (_diagnosticContext.Measure($"{nameof(ProductService)}.{nameof(GetAllPagedAsync)}"))
            return _productService.GetAllPagedAsync(page, pageSize, cancellationToken);
    }

    public async Task<Product> GetProductByIdAsync(int id, CancellationToken cancellationToken)
    {
        using (_diagnosticContext.Measure($"{nameof(ProductService)}.{nameof(GetProductByIdAsync)}"))
    ...
    {
        using (_diagnosticContext.Measure($"{nameof(ProductService)}.{nameof(GetProductByCategoryIdAsync)}"))
    ...
    {
        using (_diagnosticContext.Measure($"{nameof(ProductService)}.{nameof(GetProductByCategoriesIdsAsync)}"))
    ...
    {
        using (_diagnosticContext.Measure($"{nameof(ProductService)}.{nameof(CreateProductAsync)}"))
    ...
    {
        using (_diagnosticContext.Measure($"{nameof(ProductService)}.{nameof(UpdateProductAsync)}"))
    ...
    {
        using (_diagnosticContext.Measure($"{nameof(ProductService)}.{nameof(DeleteProductByIdAsync)}"))
